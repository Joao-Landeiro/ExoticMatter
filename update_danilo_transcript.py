...
with open('S1E3_Danilo.html', 'r') as f:
    html_content = f.read()
...
if transcript_match:
    ...
    # Find Danilo's episode (episode-3) and update the transcript
    for episode in episodes:
        if episode['id'] == 'episode-3':
    ...
    print('Danilo transcript updated successfully!')
else:
